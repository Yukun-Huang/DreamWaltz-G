...
def project_world3d_to_2d(keypoints_3d, K, R, T) -> np.ndarray:
...
def project_camera3d_to_2d(keypoints_3d, K) -> np.ndarray:
    # keypoints_3d: numpy array of shape (Keypoints, 3)
    # K: camera intrinsic matrix (3x3)
...
def transform_keypoints_to_novelview(keypoints_3d, R, T, R_prime, T_prime) -> np.ndarray:
    """
...
def lift_2d_keypoints_to_camera3d(keypoints_2d, K) -> np.ndarray:
    """
...
def lift_2d_keypoints_to_world3d(keypoints_2d, K, R, T) -> np.ndarray:
    """
